...
个人项目上，包括两个项目，主要的项目就是一个RPC框架的设计与实现，项目基于Zookeeper实现注册中心功能，支持服务的注册和订阅功能，实现了两种负载均衡策略。在网络传输上使用Netty，序列化使用了Kryo和ProtoStuff两种方式。除了基础的RPC功能，还通过动态代理，自定义注解和ExtensionLoader对整个框架进行了优化。
...
![builder-pattern](https://wiki.jikexueyuan.com/project/java-design-pattern/images/builder-pattern-1.jpg)
